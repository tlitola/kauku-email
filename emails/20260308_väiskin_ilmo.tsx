	...
	>
		<SectionsWrapper alternateColors={false}>
			<Section>
				...
				<Text>
					Väiskin ilmoittautuminen päättyy huomenna 9.3.! Nyt on siis viimeistään korkea aika ilmoittautua leirille!
				</Text>
				<Text>Tulethan mukaan kokemaan yhteistä leirielämää Kauka-Kuuttien kanssa!</Text>
				<Text>
					Tämä viesti ei ollut maaliskuun alussa lähtenyt kaikille jäsenille. Jos olet saanut viestin jo silloin,
					kirjeessä ei ole uutta tietoa! Lippukunnan tuen hakuaikaa on tämän vuoksi jatkettu viikolla.
				</Text>
				<Text>
			...
			<Section>
				...
				<Text>
					<b>Haettehan tukea 16.3. mennessä!</b>
				</Text>
